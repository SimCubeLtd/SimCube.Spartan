...
public sealed class MediatedRequestAttribute : Attribute
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MediatedRequestAttribute"/> class.
    /// </summary>
    /// <param name="method">The mediated request method.</param>
    /// <param name="route">The route to register the endpoint on.</param>
    public MediatedRequestAttribute(RequestType method, string route)
    {
        Method = method;
        Route = route;
    }
